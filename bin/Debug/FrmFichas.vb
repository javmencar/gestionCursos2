...
Public Class FrmFichas
    ...
    Private Sub cargarcomboCursos()
        Try
            Dim sql As String = "select cursos.Id, cursos.CodCur, cursos.nombre from Cursos"
            cn.Open()
            ...
            If nuevo = True Then ' si es nueva ficha, simplemente cargo el combo para poder elegir
                ...
                While dr.Read
                    Me.cboCursos.Items.Add(String.Format("{0}*{1}*{2}", dr(0), dr(1), dr(2)))
                End While
            Else
                dr = cmd.ExecuteReader
                While dr.Read
    ...
    Private Sub cboCursos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboCursos.SelectedIndexChanged
        Me.txtCurso.Text = ""
        Dim aux(3) As String
        aux = Split(Me.cboCursos.SelectedItem.ToString, "*")
